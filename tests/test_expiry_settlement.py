...
def test_spot_above_short_strike_is_max_profit():
    pnl = expiry_settlement_pnl(
        spot=445.0, short_strike=440.0, long_strike=435.0, width=5.0, entry_credit=0.40
    )
...
def test_spot_at_short_strike_is_max_profit_boundary():
    pnl = expiry_settlement_pnl(
        spot=440.0, short_strike=440.0, long_strike=435.0, width=5.0, entry_credit=0.40
    )
    assert pnl == pytest.approx(0.40)
...
def test_spot_below_long_strike_is_max_loss():
    pnl = expiry_settlement_pnl(
        spot=430.0, short_strike=440.0, long_strike=435.0, width=5.0, entry_credit=0.40
    )
...
def test_spot_at_long_strike_is_max_loss_boundary():
    pnl = expiry_settlement_pnl(
        spot=435.0, short_strike=440.0, long_strike=435.0, width=5.0, entry_credit=0.40
    )
...
def test_spot_between_strikes_is_linear_intrinsic():
    ...
    pnl = expiry_settlement_pnl(
        spot=437.0, short_strike=440.0, long_strike=435.0, width=5.0, entry_credit=0.40
    )
